var sentances = [
	...
	"As we begin the New Year I want to share with you several changes to our management",
	"Tara Comonte will be departing as Chief Financial Officer",
	"Tara has been a key member of the McCann Worldgroup Leadership Team over the past two+ years as well as a founding leader in the creation of IPG Mediabrands",
	"I want to personally thank Tara for helping with the transition into my new role",
	"I am also very pleased to announce that Gary Lee will be returning to Worldgroup as Chief Financial Officer",
	"Gary served as CFO for Worldgroup for four years and prior to joining Worldgroup was COO and CFO for Ogilvy & Mather",
	"During the course of the next 2 months Tara will assist in the transition",
	"Craig Smith will be joining Worldgroup from CMG as our new Chief Information Officer",
	"Craig was instrumental in developing and building the technology infrastructure at CMG",
	"He will look to integrate leading-edge technology across Worldgroup and make sure we have the best resources available in the marketplace to help drive our own and our clients' business",
	"All IT operations across Worldgroup will report into Craig",
	"Ed Powers, who served as Chief Operations Officer at CMG and earlier held the same post at Lowe will assume the role of EVP, Operations for Worldgroup",
	"As part of his responsibilities Ed will have oversight of Worldgroup Human Resources and IT",
	"Joe Kelly, Chief Talent Officer, and Craig Smith will report directly to him",
	"Ed will also work with Luca and Gustavo to further develop network strategy and infrastructure",
	"Finally, with regard to Worldgroup communications, Jeremy Miller, Chief Communications Officer for McCann Erickson will now have responsibility for all of our external and internal communications across Worldgroup, with all communications functions reporting to him",
	"These executives along with our leaders across the creative, strategic and account disciplines will ensure that we continue to support you, drive our overall growth and service our clients",
	"Please join me in welcoming Gary back to Worldgroup and congratulating Ed, Jeremy and Craig on their new roles",
	"I am pleased to announce that Daryl Lee has been promoted to Global CEO of UM, McCann Worldgroup's global media agency partner",
	"Before coming over to McCann in mid-2010, Daryl was President of Global Strategy at UM, which is a division of IPG Mediabrands",
	"Daryl first joined as McCann Worldgroup's Chief Integration Architect",
	"In that role, he founded and launched McCann Truth Central, developed and rolled out Truth2Transformation as our global way of working, and created the Strategic Leadership Council (SLC)",
	"Most recently he has been serving as Chief Strategy Officer for McCann Erickson",
	"His contributions over the last few years have been considerable",
	"In addition to his role in improving our strategic expertise and capabilities overall, he has provided critical strategic leadership on many of our global accounts",
	"Please join me in congratulating Daryl on his new position",
	"This week, the Point of Purchase Advertising International (POPAI) Hall of Fame has announced its list of 2013 inductees and I am very proud to share the news that our very own Bill Kolb, Chairman & CEO of Commonwealth and Chairman of MRM, will be one of those to receive this honor",
	"As I have said before, Bill is one of our most experienced multiplatform and global marketing executives and his record at MRM has been impressive, both in driving the agency's overall growth and in building its reputation",
	"His collaborative, energetic and insightful leadership style is one of the biggest reasons why he, and MRM, have been so successful",
	"POPAI is an international trade association for the marketing at retail industry and has been promoting innovation in retail since 1936",
	"Bill's election to the association's Hall of Fame makes him one of a very select group of leaders whose contributions to the retail industry continue to set new standards for excellence",
	"Please join me in congratulating Bill on this incredible honor",
	"We just received some terrific news",
	"For the second year in a row, we have been recognized as Healthcare Agency Network Of The Year at the 2013 Global Awards—The World's Best Healthcare & Wellness Advertising show",
	"And, we were named Effie Network of the Year & Effie Agency of the Year at the Middle East North Africa Effie Awards",
	"I want everyone to know how proud I am of the work you are doing",
	"2013 has been a fantastic year for our clients' businesses and for our creative reputation",
	"We have made impressive showings at all of the global, regional and local awards shows this year",
	"Please join me in congratulating Ghassan Harfouche, Akram Miknas, Tarek Miknas and the entire FP7 team, and Jeremy Perrott and John Cahill and the Health team, for their award-winning and effective work"
];
